...
import com.dainiak.servlets.utils.TestObj;
        ...
        try {
            ...
            if (attr instanceof ArrayList){
                ...
                for (Object str : list) {
                   ...
                   //ut.println("<h1>" +((TestObj)request.getAttribute("obj")).getName() +"</h1>");
                }
            ...
            //out.println("<h1>" +((TestObj)request.getAttribute("obj")).getName() +"</h1>");
            out.println("</body>");
            out.println("</html>");
            out.close();
        }
